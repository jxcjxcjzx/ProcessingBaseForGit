...
// testing area, you can delete it or alter it as you like
MAkePossible imap = new MAkePossible();
...
//    readbooks.handle_in_setup();
    ...
    // testing area, you can delete or alter it as you like
    imap.handle_in_setup();
